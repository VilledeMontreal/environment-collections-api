...
# Contributor Covenant Code of Conduct for the environment-collections-api project

Contributors to repositories hosted in environment-collections-api are expected to follow the Contributor Covenant Code of Conduct, and those working within City of Montreal are also expected to follow the Code of Conduct for the City of Montreal Employees 
...
This Code of Conduct applies both within project spaces and in public spaces when an individual is representing the project or its community in the public spaces.
Examples of representing a project or its community include using an official project e-mail address, posting via an official social media account, or acting as an appointed representative at an online or offline event.
Representation of a project may be further defined and clarified by project maintainers.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at support.gad@montreal.ca.
...
# Code de conduite pour le projet environment-collections-api

Les contributeurs aux dépôts hébergés dans environment-collections-api sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein de la Ville de Montréal sont également tenus de respecter le Code de conduite des employés de la Ville de Montréal.
...
Les cas de comportement abusif, de harcèlement ou d'autres comportements inacceptables peuvent être rapportés en communiquant avec l'équipe de projet à l'adresse suivante :support.gad@montreal.ca.
